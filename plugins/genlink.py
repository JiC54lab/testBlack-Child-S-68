...
async def gen_link_batch(bot, message):
    if " " not in message.text:
        return await message.reply("Use correct format.\nExample <code>/batch https://t.me/JiC54_dax/63 https://t.me/JiC54_dax/71</code>.")
    links = message.text.strip().split(" ")
    if len(links) != 3:
        return await message.reply("Use correct format.\nExample <code>/batch hhttps://t.me/african_movies_channel/110 https://t.me/african_movies_channel/120</code>.")
    _, first, last = links
